                        ...
                        <div x-show="open" @click.away="open = false" x-cloak
                            ...
                            @foreach($projects as $p)
                                <a href="{{ route('dashboard.overview', $p) }}"
                                    class="block px-4 py-2 text-sm text-foreground hover:bg-accent {{ isset($project) && $p->id === $project->id ? 'bg-accent text-foreground' : '' }}">
                                    {{ $p->name }}
                                </a>
                            @endforeach
            ...
            <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
                ...
                @if(isset($project))
                    ...
                    <div class="pt-2"
                        ...
                        <div x-show="customersOpen" class="pl-8 mt-1 space-y-1">
